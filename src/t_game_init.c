...
void	game_image_player_init(t_game_state *game)
{
	game->img_p_down = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/krobusdown.png", &game->img_width, &game->img_height);
	game->img_p_up = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/krobusup.png", &game->img_width, &game->img_height);
	game->img_p_left = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/krobusleft.png", &game->img_width, &game->img_height);
	game->img_p_right = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/krobusright.png", &game->img_width, &game->img_height);
}
...
void	game_image_ground_init(t_game_state *game)
{
	game->img_lwall = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/leftwall.png", &game->img_width, &game->img_height);
	game->img_rwall = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/rightwall.png", &game->img_width, &game->img_height);
	game->img_twall = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/topwall.png", &game->img_width, &game->img_height);
	game->img_bwall = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/bottomwall.png", &game->img_width, &game->img_height);
	game->img_tlwall = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/topleft.png", &game->img_width, &game->img_height);
	game->img_trwall = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/topright.png", &game->img_width, &game->img_height);
	game->img_blwall = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/bottomleft.png", &game->img_width, &game->img_height);
	game->img_brwall = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/bottomright.png", &game->img_width, &game->img_height);
	game->img_1wall = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/1wall.png", &game->img_width, &game->img_height);
	game->img_floor = mlx_new_image_from_file(game->mlx,
	 "textures/stardew/16_16.png", &game->img_width, &game->img_height);
}

void	game_win_init(t_game_state *game)
{
	game->win_info.title = "so_long";
	game->win_info.height = game->tile_side_px * game->map_info.map_height;
	game->win_info.width = game->tile_side_px * game->map_info.map_width;
